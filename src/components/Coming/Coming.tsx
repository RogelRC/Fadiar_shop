    ...
    return (
        <div className={"flex w-full h-[70vh] bg-[#F5F5F5] px-10 py-20 items-center"}>
            <div className={"flex flex-col gap-10 w-2/5 h-full text-[#022953] justify-center"}>
                ...
                <p>En este texto se debe explicar brevemente la empresa, cual es su finalidad, los servicios más importantes que se ofrecen, entre otras cuestiones la la la.</p>
                <Button className={"flex bg-[#022953] font-bold rounded-none w-52"}>LEER MÁS</Button>
            </div>
            <div className={"flex w-full h-full items-center justify-center p-5 relative"}>
                <Carousel
                    opts={{
                        align: "start",
                    }}
